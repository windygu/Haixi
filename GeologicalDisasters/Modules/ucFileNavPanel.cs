...
namespace ComprehensiveEvaluation.Modules
{
    public partial class ucFileNavPanel : UserControl
    {
        ...
        private void AddLayerToMapControl(TreeListNode node)
        {
            ...
            else if (GISHandler.GISLayers.IsSupportLayerType(extension))
            {
                GISHandler.GISLayers.OpenRaster(path, this.axMapControl);
            }
            else
            {
